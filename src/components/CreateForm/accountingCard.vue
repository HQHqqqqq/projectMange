  ...
  <div class="application">
    <div class="navTop" v-if=" this.department!=''" style="float:right">
      <el-row class="el-right mr15 navrig">
        <Time :name="depname" class="navrtime"></Time>
        <!-- <el-button class="btn" @click="downloadFile()" type="primary">导出</el-button> -->
    ...
    <div class="cation" :value="index" :key="index" v-for="(item,index) in department ">
      ...
      >
        ...
        <el-table-column prop="filed10" label="合同金额" width="110">
          <template slot-scope="scope">
            <p>¥ {{ scope.row.filed10 | formatThousands }}</p>
          </template>
        </el-table-column>
        <el-table-column prop="filed26" label="预计纯合同额" width="110">
          <template slot-scope="scope">
            <p>¥ {{ scope.row.filed26 | formatThousands}}</p>
          </template>
        </el-table-column>
        <el-table-column prop="filed31" label="预计毛利润" width="95">
          <template slot-scope="scope">
        ...
        <el-table-column prop="filed34" label="预计损益收益率" width="120">
          <template slot-scope="scope">
            <p>{{ scope.row.filed34 }}%</p>
          </template>
        </el-table-column>
        <el-table-column prop="filed26" label="实际纯合同额" width="110">
          <template slot-scope="scope">
            <p>¥ {{ scope.row.filed26 | formatThousands}}</p>
          </template>
        </el-table-column>
        <el-table-column prop="filed35" label="实际毛利润" width="100">
          <template slot-scope="scope">
        ...
        <el-table-column prop="filed38" label="实际损益收益率" width="120">
          <template slot-scope="scope">
